from backend.apps.scaffold_web_agent.lead_service import LeadService
...
def test_lead_service_create_lead_delegates(monkeypatch):
    ...
    monkeypatch.setattr(
        "backend.apps.scaffold_web_agent.lead_service.insert_lead",
        fake_insert_lead,
    )
...
def test_lead_service_list_for_tenant_delegates(monkeypatch):
    ...
    monkeypatch.setattr(
        "backend.apps.scaffold_web_agent.lead_service.list_leads_for_tenant",
