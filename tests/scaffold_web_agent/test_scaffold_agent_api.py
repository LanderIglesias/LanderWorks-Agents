...
from backend.agents.scaffold_web_agent.api import get_mailer, get_settings
from backend.agents.scaffold_web_agent.mailer import FakeMailer
from backend.agents.scaffold_web_agent.tenants import Tenant, upsert_tenant
...
def test_admin_tenant_analytics_uses_analytics_service(monkeypatch):
    ...
    monkeypatch.setattr(
        "backend.agents.scaffold_web_agent.api._analytics_service",
...
def test_scaffold_chat_endpoint_uses_runtime(monkeypatch):
    ...
    monkeypatch.setattr(
        "backend.agents.scaffold_web_agent.api._tenant_service",
        DummyTenantService(),
    )
    monkeypatch.setattr(
        "backend.agents.scaffold_web_agent.api._registry",
        DummyRegistry(),
    )
...
def test_admin_list_events_uses_event_service(monkeypatch):
    ...
    monkeypatch.setattr(
        "backend.agents.scaffold_web_agent.api._event_service",
        DummyEventService(),
    )
    monkeypatch.setenv("ADMIN_TOKEN", "admin-secret")
